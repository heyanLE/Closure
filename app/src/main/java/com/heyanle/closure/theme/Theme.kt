...
import com.heyanle.closure.theme.colors.DefaultColor
import com.heyanle.closure.theme.colors.GreenappleColor
import com.heyanle.closure.theme.colors.MidnightduskColor
import com.heyanle.closure.theme.colors.StrawberryColor
import com.heyanle.closure.theme.colors.TakoColor
import com.heyanle.closure.theme.colors.TealturqoiseColor
...
enum class EasyThemeMode(
    ...
    Strawberry(
        ...
        com.heyanle.i18n.R.string.theme_strawberry,
    ),
    ...
    Tako(
        ...
        com.heyanle.i18n.R.string.theme_tako,
    ...
    Tealturqoise(
        ...
        com.heyanle.i18n.R.string.theme_tealturqoise,
