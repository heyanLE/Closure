...
fun EmptyPage(
    modifier: Modifier = Modifier,
    emptyMsg: String = stringResource(id = com.heyanle.i18n.R.string.instance_empty),
    msgColor: Color = MaterialTheme.colorScheme.onBackground.copy(alpha = 0.6f),
    other: @Composable () -> Unit = {},
) {
    WhitePage(modifier, R.drawable.texas, emptyMsg, other = other, msgColor = msgColor)
}

@Composable
fun LoadingPage(
    modifier: Modifier = Modifier,
    loadingMsg: String = stringResource(id = com.heyanle.i18n.R.string.loading),
    msgColor: Color = MaterialTheme.colorScheme.onBackground.copy(alpha = 0.6f),
    other: @Composable () -> Unit = {},
) {
    WhitePage(modifier, Uri.parse("file:///android_asset/loading.gif"), loadingMsg, other = other, msgColor = msgColor)
}
