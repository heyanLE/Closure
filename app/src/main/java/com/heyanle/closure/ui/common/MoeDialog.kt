...
data class MoeDialogData(
    ...
    val dismissLabel: String = stringRes(com.heyanle.i18n.R.string.cancel),
    val confirmLabel: String = stringRes(com.heyanle.i18n.R.string.confirm),
...
fun String.moeDialog(
    ...
    confirmLabel: String = stringRes(com.heyanle.i18n.R.string.confirm),
    dismissLabel: String = stringRes(com.heyanle.i18n.R.string.cancel),
